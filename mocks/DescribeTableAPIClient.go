...
func (_m *DescribeTableAPIClient) DescribeTable(_a0 context.Context, _a1 *dynamodb.DescribeTableInput, _a2 ...func(*dynamodb.Options)) (*dynamodb.DescribeTableOutput, error) {
